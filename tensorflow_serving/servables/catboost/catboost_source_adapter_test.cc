...
#include "tensorflow_serving/servables/catboost/catboost_source_adapter.h"
...
namespace serving {
namespace {
TEST(CatBoostSourceAdapterTest, Basic) {
  ...
  *servable_0->mutable_servable_version_policy() = spolicy;
  ...
  auto adapter =
      std::unique_ptr<CatBoostSourceAdapter>(new CatBoostSourceAdapter());
